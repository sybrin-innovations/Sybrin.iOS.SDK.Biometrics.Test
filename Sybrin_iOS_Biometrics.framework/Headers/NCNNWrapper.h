...
+(double)returnFaceDetectionPrediction: (nonnull UIImage *)rawImage;

+(nullable NSArray *)getCurrentFeatureSample;
+(bool)setCurrentFeatureSample: (nonnull NSArray *)featureSetNSArray;
